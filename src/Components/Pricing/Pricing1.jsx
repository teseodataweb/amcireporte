    ...
    return (
        ...
        <div className="container">
            <div className="section-title text-center mxw-685 mx-auto">
                ...
                <p className="text">Reporte Completo: Perspectivas del Mercado de Concreto en México 2025
                </p>
            </div>
                    ...
                    <div className={`tab-pane ${isActive === 'monthly' ? 'active' : ''}`} id="pills-monthly" role="tabpanel"
                        ...
                        <div className="row gy-5">
                            ...
                            <PricingCard
                                ...
                                content="Incluye"
                                FeatureList={[
                                    "Descarga directa en PDF (más de 45 páginas)",
                                    "Envío automático al correo electrónico",
                                    "Datos del mercado nacional por región y sector",
                                    "Oportunidades estratégicas para concreteros independientes",
                                    "Proyecciones hasta 2032 respaldadas por IA",
                                    "Uso comercial y profesional permitido",
                                ]} 
